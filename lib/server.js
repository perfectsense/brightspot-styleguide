                ...
                fs.readdirSync(groupPath).forEach(function (example) {
                    ...
                    if (example.slice(0, 1) !== '_') {
                        ...
                        if (fs.statSync(examplePath).isDirectory()) {
                            ...
                            previousPath = library.urlPrefix + '/' + group + '/' + example;
                            lastExample = {
                                name: label(example),
                        ...
                        } else if(fs.statSync(examplePath).isFile() && group) {
                            secondaryExamples.push({
                                name: label(example),
                                url: previousPath+ '/' + example.slice(0, -config['json-suffix'].length) + originalUrlSearch
                            });
                        }
