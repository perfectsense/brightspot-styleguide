...
module.exports = function (config, req, res, context) {
    ...
    // Marks the template as the default block body.
    var DEFAULT_BLOCK_BODY_TEMPLATE_DATA = DATA_PREFIX + 'defaultBlockBodyTemplate';

    handlebars.registerHelper('defaultBlockBody', function (options) {
        var overrideTemplate = this[DEFAULT_BLOCK_BODY_TEMPLATE_DATA];
        var override;
    ...
    handlebars.registerHelper('block', function (name, options) {
        ...
        this[DEFAULT_BLOCK_BODY_TEMPLATE_DATA] = options.fn;
    ...
    handlebars.registerHelper('defineElement', function (name, options) {
        this[ELEMENT_DEFINITION_DATA_PREFIX + name] = {
            name: options.data[BLOCK_NAME_DATA] + '-' + name,
            options: options
        };
    });
    ...
    handlebars.registerHelper('element', function (name) {
        var element = this[ELEMENT_DEFINITION_DATA_PREFIX + name];
        ...
        var value = this[name];
        var fnOptions = { data: { } };
        fnOptions.data[ELEMENT_NAME_DATA] = element.name;
