...
module.exports = function (config) {
  ...
  app.use(config.baseUrl, function (req, res) {
    ...
    handlebars.registerPartial('layout', fs.readFileSync(styleguidePaths.find('/layout.hbs'), 'utf8'));

    var template = handlebars.compile(fs.readFileSync(styleguidePaths.find('/main.hbs'), 'utf8'));
