...
module.exports = {
  registerModule: (styleguide) => {
    ...
    styleguide.gulp.task('bsp-styleguide:copy:templates', ['bsp-styleguide:copy:createPackageFile'], () => {
    ...
    styleguide.gulp.task('bsp-styleguide:copy:createPackageFile', ['bsp-styleguide:copy:node_modules'], () => {
    ...
    styleguide.gulp.task('bsp-styleguide:copy:node_modules', () => {
