...
DataGenerator.prototype.color = function(tint) {
    var color;
    if(tint == 'dark') {
        var red = this.number([0,150]),
            green = this.number([0,150]),
            blue = this.number([0,150]);
        color = 'rgb(' + red + ',' + green + ',' + blue + ')';

    } else if(tint == 'light') {
        var red = this.number([150,255]),
            green = this.number([150,255]),
            blue = this.number([150,255]);
        color = 'rgb(' + red + ',' + green + ',' + blue + ')';

    } else {
        color = this.chance.color({format: 'rgb'});
    }
    return color;
};
